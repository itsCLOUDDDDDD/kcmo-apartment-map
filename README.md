...
The latest verified release contains **258 properties: 253 mapped and five list-only**, 59 saved venues, 26 structured units and 2,808 saved Google walking measurements. The live Google Sheet remains the data master; publication does not fetch or edit it. Missing facts remain unresolved. Walking measurements without geometry display without fabricated routes.
