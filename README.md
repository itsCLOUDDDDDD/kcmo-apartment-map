...
The current snapshot contains **106 properties: 104 mapped and two list-only**, 59 venue records (58 accepted coordinate pairs and one unresolved), 21 structured units and 2,808 saved Google walking measurements. The live Google Sheet remains the data master; publication does not fetch or edit it. Missing facts remain unresolved. Walking measurements without geometry display without fabricated routes.
