...
Facilities use separate Map Places IDs and source-dated property access relationships, not additional housing candidates or automatic Scene/routing destinations. Distinguish in-unit, on-site, shared-complex, optional off-site membership and unknown access; optional packages never alter the planning setting or imply host-resident fees. Keep facility media owned by its facility. Unknown entrances remain list-only. An address correction invalidates current location/route bindings while preserving historical evidence. Private unit quotations without confirmed unit identity or source dates remain private building-linked evidence, not fresh vacant units.
