...
function P(e, t) {
	...
	if (t === 2 || t === 1) {
		...
		return i.length / 3 !== r && console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles."), e.setIndex(i), e.clearGroups(), e;
	}
	return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:", t), e;
}
//#endregion
//#region node_modules/.pnpm/three@0.186.0/node_modules/three/examples/jsm/utils/SkeletonUtils.js
function De(e) {
...
//#endregion
//#region node_modules/.pnpm/three@0.186.0/node_modules/three/examples/jsm/loaders/GLTFLoader.js
var Oe = class extends se {
	...
	parse(e, t, n, r) {
		...
		if (typeof e == "string") i = JSON.parse(e);
			...
			if (s.decode(new Uint8Array(e, 0, 4)) === z) {
				try {
...
var L = {
	...
	createNodeMesh(e) {
		...
		let a = n.extensions[this.name].attributes, o = [], s = {};
		for (let e in a) o.push(this.parser.getDependency("accessor", a[e]).then((t) => (s[e] = t, s[e])));
		return o.length < 1 ? null : (o.push(this.parser.createNodeMesh(e)), Promise.all(o).then((e) => {
			let t = e.pop(), n = t.isGroup ? t.children : [t], r = e[0].count, a = [];
			for (let e of n) {
				let t = new S(), n = new M(), o = new D(), c = new M(1, 1, 1), l = new p(e.geometry, e.material, r);
				for (let e = 0; e < r; e++) s.TRANSLATION && n.fromBufferAttribute(s.TRANSLATION, e), s.ROTATION && o.fromBufferAttribute(s.ROTATION, e), s.SCALE && c.fromBufferAttribute(s.SCALE, e), l.setMatrixAt(e, t.compose(n, o, c));
				let u = null;
				for (let e in s) if (e === "_COLOR_0") {
					let t = s[e];
					l.instanceColor = new f(t.array, t.itemSize, t.normalized);
				} else if (e !== "TRANSLATION" && e !== "ROTATION" && e !== "SCALE") {
					if (u === null) {
						let e = l.geometry;
						u = new i(), u.name = e.name;
						for (let t in e.attributes) u.setAttribute(t, e.attributes[t]);
						for (let t in e.morphAttributes) u.morphAttributes[t] = e.morphAttributes[t];
						e.index !== null && u.setIndex(e.index), u.morphTargetsRelative = e.morphTargetsRelative;
						for (let t of e.groups) u.addGroup(t.start, t.count, t.materialIndex);
						e.boundingBox !== null && (u.boundingBox = e.boundingBox.clone()), e.boundingSphere !== null && (u.boundingSphere = e.boundingSphere.clone()), u.drawRange.start = e.drawRange.start, u.drawRange.count = e.drawRange.count, u.userData = Object.assign({}, e.userData), l.geometry = u;
					}
					let t = s[e];
					u.setAttribute(e, new f(t.array, t.itemSize, t.normalized));
				}
				E.prototype.copy.call(l, e), this.parser.assignFinalMaterial(l), a.push(l);
			}
	...
	extendTexture(e, t) {
		...
		if (e = e.clone(), t.texCoord !== void 0 && (e.channel = t.texCoord), t.offset !== void 0 && e.offset.fromArray(t.offset), t.rotation !== void 0 && (e.rotation = t.rotation), t.scale !== void 0 && e.repeat.fromArray(t.scale), t.rotation !== void 0) {
			let t = Math.cos(e.rotation), n = Math.sin(e.rotation);
			e.matrix.set(e.repeat.x * t, e.repeat.y * n, e.offset.x, -e.repeat.x * n, e.repeat.y * t, e.offset.y, 0, 0, 1), e.matrixAutoUpdate = !1;
		}
...
var ot = new S(), st = class {
	constructor(e = {}, t = {}) {
		...
		this.textureLoader = typeof createImageBitmap > "u" || n && r < 17 || i && a < 98 ? new Ee(this.options.manager) : new d(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new l(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(!0);
	}
	setExtensions(e) {
		this.extensions = e;
	}
	...
	loadGeometries(e) {
		...
		for (let n = 0, s = e.length; n < s; n++) {
			...
			if (l) o.push(l.promise);
				...
				let e;
				e = s.extensions && s.extensions[L.KHR_DRACO_MESH_COMPRESSION] ? a(s) : lt(new i(), s, t), s.mode === U.TRIANGLE_STRIP ? e = e.then((e) => P(e, 1)) : s.mode === U.TRIANGLE_FAN && (e = e.then((e) => P(e, 2))), r[c] = {
					primitive: s,
					promise: e
				}, o.push(e);
			}
	...
	loadMesh(e) {
		...
		return o.push(t.loadGeometries(a)), Promise.all(o).then(async function(n) {
			...
			for (let n = 0, l = s.length; n < l; n++) {
				...
				if (u.mode === U.TRIANGLES || u.mode === U.TRIANGLE_STRIP || u.mode === U.TRIANGLE_FAN || u.mode === void 0) {
					let e = i.isSkinnedMesh === !0, t = l.hasAttribute("skinIndex") && l.hasAttribute("skinWeight");
					e && t === !1 && console.warn("THREE.GLTFLoader: Missing skinIndex or skinWeight attributes. Skinning disabled."), d = e && t ? new Ce(l, f) : new le(l, f), d.isSkinnedMesh === !0 && d.normalizeSkinWeights();
